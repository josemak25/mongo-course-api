...
connection('mongodb://localhost/playground')
    .then(function (response) { return console.log('connected successfully'); })
...
var createCourse = function (course) { return __awaiter(_this, void 0, void 0, function () {
    var firstCourse, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                firstCourse = Course.create(course);
                return [4 /*yield*/, firstCourse];
            case 1:
                result = _a.sent();
                console.log(result);
                return [2 /*return*/];
